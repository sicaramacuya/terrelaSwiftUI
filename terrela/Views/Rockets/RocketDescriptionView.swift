...
struct RocketDescriptionView: View {
        
    var item: RocketsItems
...
struct RocketDescriptionView_Previews: PreviewProvider {
    static var previews: some View {
        RocketDescriptionView(item: rockets[0])
    }
}
